                    ...
                    $html .= '<tr valign="top">';
						$html .= '<div class="ut-minicolors-wrap">';
							...
							$html .= '<td>';
								...
								$html .= '<input data-mode="gradient" type="text" name="' . esc_attr( $k ) . '[hover_color]" id="' . esc_attr( $k ) . '_hover_color" value="' . $this->validate_value( $data , 'hover_color' ) . '" class="ut-ui-form-input ut-gradient-picker" autocomplete="off" />';                  
