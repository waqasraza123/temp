					...
					<ul class="wpb-content-layouts-container">
						<li class="vc_add-element-deprecated-warning">
							<div class="wpb_element_wrapper">
                                <!-- @United -->
								<?php echo vc_message_warning( __( 'Modules within this list are deprecated and are no longer supported in newer versions of WPBakery Page Builder.', 'js_composer' ) ) ?>
							</div>
						</li>                        
