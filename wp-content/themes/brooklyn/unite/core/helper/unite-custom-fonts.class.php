	...
	public function menu_highlight() {
		...
		<script>
			jQuery(document).ready( function( $ ) {
				...
				$wrapper.find( 'tr.form-field.term-name-wrap p, div.form-field.term-name-wrap > p' ).text( '<?php esc_html_e( 'The name of the font used in the attached CSS file.', 'pojo-cwf' ); ?>' );
