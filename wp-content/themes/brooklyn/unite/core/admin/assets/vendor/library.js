...
;(function($, window, document, undefined){
    ...
    deps_iteration = function( rule, block ) {
    ...
    rules_iteration = function( rules, block , num, numToUpdate ) {
    ...
    return this.each(function(){
      ...
      requestAnimationFrame( rules_iteration( rules, block, 0, 30 ) );
