...
/**
 * Recognized Google Font JavaScript Array
 *
 * @return    array
 *
 * @access    public
...
if ( !function_exists( '_ut_recognized_js_google_font_array' ) ) {

    function _ut_recognized_js_google_font_array() {
        ...
        foreach ( ut_recognized_google_fonts() as $id => $font ) {
            ...
            $js_data_array[$id]['id']       = $id;
            $js_data_array[$id]['text']     = $font['family'];
            $js_data_array[$id]['variants'] = $variants;
            $js_data_array[$id]['subsets']  = $subsets;
            
        }        
        
        return $js_data_array;
    ...
    function _ut_search_js_google_font_array() {
        ...
        foreach ( ut_recognized_google_fonts() as $id => $font ) {
            ...
            if( strpos($current, $keyword ) !== false) {
                ...
                // the main stuff
                $js_search_result[$count]["id"]       = preg_replace( '/\s+/', '', strtolower( $font['family'] ) );
