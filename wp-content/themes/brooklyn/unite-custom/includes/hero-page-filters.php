...
function _ut_page_hero_config( $config ) {
    ...
    $config = array_merge( array(
            ...
            'ut_hero_custom_logo' => 'ut_page_custom_hero_logo',
            'ut_hero_custom_logo_max_width' => 'ut_page_hero_custom_logo_max_width',
            'ut_hero_custom_logo_max_width_tablet' => 'ut_page_hero_custom_logo_max_width_tablet',
            'ut_hero_custom_logo_max_width_mobile' => 'ut_page_hero_custom_logo_max_width_mobile',
            'ut_hero_custom_logo_margin_bottom' => 'ut_page_hero_custom_logo_margin_bottom',
...
function _ut_system_page_hero_support( $config ) {
    ...
    if ( is_search() || is_404() || is_archive() || is_category() || apply_filters( 'ut_maintenance_mode_active', false ) ) {
