...
/** 
 * Prints HTML with uploaded theme logo
 *
 * @return    html
 *
 * @access    public
...
if ( ! function_exists( 'unite_theme_logo' ) ) :
    
    function unite_theme_logo() {
        
        if ( get_theme_mod( 'ut_site_logo' ) ) :
 ...
 * @version   1.0.0
 */
function ut_create_header_placeholder() {
    
    if( ut_return_header_config( 'ut_navigation_state' , 'off' ) == 'on_transparent' || ut_return_header_config( 'ut_navigation_state' , 'off' ) == 'off' || ut_return_header_config( 'ut_navigation_scroll_position', 'floating' ) == 'fixed' ) {
        return;
    }    
