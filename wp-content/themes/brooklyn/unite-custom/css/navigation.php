        ...
        public function custom_css() {
            ...
            <?php if( ut_return_header_config( 'ut_navigation_skin' , 'ut-header-light' ) == 'ut-header-custom' ) : ?>            
                ...
                <?php if( ut_return_header_config( 'ut_navigation_ps_hover_state', 'off' ) == 'on' && ut_return_header_config( 'ut_header_ps_hover_text_logo_color' ) ) : ?>
				    ...
				    #ut-sitebody #header-section.ut-secondary-custom-skin.ha-header:hover h1.logo a {
                ...
                <?php if( ut_return_header_config( 'ut_navigation_ps_hover_state', 'off' ) == 'on' && ut_return_header_config( 'ut_header_ps_hover_text_logo_color_hover' ) ) : ?>
					...
					#ut-sitebody #header-section.ut-secondary-custom-skin.ha-header:hover h1.logo a:hover,
                    #ut-sitebody #header-section.ut-secondary-custom-skin.ha-header:hover h1.logo a:focus,
                    #ut-sitebody #header-section.ut-secondary-custom-skin.ha-header:hover h1.logo a:active {
                ...
                <?php if( ut_return_header_config( 'ut_navigation_ps_hover_state', 'off' ) == 'on' && ut_return_header_config( 'ut_header_ps_background_color_hover' ) ) : ?>
                    ...
                    if( $this->is_gradient( $ut_header_ps_background_color_hover ) ) : ?> 
                        ...
                        <?php echo $this->create_gradient_css( $ut_header_ps_background_color_hover, '#ut-sitebody #header-section.ut-primary-custom-skin:after, #ut-sitebody #header-section.ut-secondary-custom-skin:after', false, 'background', true ); ?>
                
                        #ut-sitebody #header-section.ut-primary-custom-skin:hover:after,
						#ut-sitebody #header-section.ut-secondary-custom-skin:hover:after {
                            opacity: 1;
                        }
                ...
                <?php if( ut_return_header_config( 'ut_navigation_ps_hover_state', 'off' ) == 'on' && ut_return_header_config( 'ut_navigation_ps_hover_fl_color_active' ) ) : ?>
					...
					#ut-sitebody #header-section.ut-secondary-custom-skin.ha-header:hover #navigation > ul > li > a.active:not(.bklyn-btn),
					#ut-sitebody #header-section.ut-primary-custom-skin.ha-header:hover #navigation > ul > li > a.selected:not(.bklyn-btn),
					#ut-sitebody #header-section.ut-secondary-custom-skin.ha-header:hover #navigation > ul > li > a.selected:not(.bklyn-btn) {
                ...
                <?php if( ut_return_header_config( 'ut_navigation_ps_hover_state', 'off' ) == 'on' && ut_return_header_config( 'ut_navigation_ps_hover_fl_color_hover' ) ) : ?>
					...
					#ut-sitebody #header-section.ut-secondary-custom-skin.ha-header:hover #navigation > ul > li > a:not(.bklyn-btn):hover,
                    #ut-sitebody #header-section.ut-secondary-custom-skin.ha-header:hover #navigation > ul > li > a:not(.bklyn-btn):active,
                    #ut-sitebody #header-section.ut-secondary-custom-skin.ha-header:hover #navigation > ul > li > a:not(.bklyn-btn):focus {
